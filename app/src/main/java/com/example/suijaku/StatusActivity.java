        ...
        for (i = 0; i < NUM_OF_PLAYERS - 1 + (NUM_OF_CARDS / NUM_OF_PLAYERS) * 2; i++) {
            for (j = 0; j < 13; j++) {
                if (joint1stlayer[i][j] > 0) {
                    ...
                    mpaint.setColor(rgb((int) ((joint1stlayer[i][j] * 255) / max_param), 0, 0));
                }
        ...
        for (i = 0; i < 13; i++) {
            for (j = 0; j < 12; j++) {
                if (joint2ndlayer[i][j] > 0) {
                    ...
                    mpaint.setColor(rgb((int) ((joint2ndlayer[i][j] * 255) / max_param), 0, 0));
                }
        ...
        for (i = 0; i < 12; i++) {
            for (j = 0; j < 11; j++) {
                if (joint3rdlayer[i][j] > 0) {
                    ...
                    mpaint.setColor(rgb((int) ((joint3rdlayer[i][j] * 255) / max_param), 0, 0));
                }
